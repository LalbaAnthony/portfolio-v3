const projectsData: Project[] = [
  {
    ...
    year: 2025,
    featured: true,
    productionUrl: "https://nova-dashboard.dev",
    repositoryUrl: "https://github.com/LalbaAnthony/nova-dashboard"
  },
  {
    slug: "cartflow",
    title: "CartFlow",
    ...
    year: 2024,
    featured: true,
    repositoryUrl: "https://github.com/LalbaAnthony/cartflow"
  },
  {
    slug: "lexify",
    title: "Lexify",
    ...
    year: 2024,
    featured: false,
    productionUrl: "https://lexify.app",
    repositoryUrl: "https://github.com/LalbaAnthony/lexify"
  },
  {
    slug: "infra-pulse",
    title: "InfraPulse",
    ...
    year: 2024,
    featured: true,
    repositoryUrl: "https://github.com/LalbaAnthony/infra-pulse"
  },
  {
    slug: "collab-board",
    title: "CollabBoard",
    ...
    year: 2023,
    featured: true,
    productionUrl: "https://collab-board.io"
  },
  {
    slug: "docship",
    title: "DocShip",
    ...
    year: 2023,
    featured: false,
    repositoryUrl: "https://github.com/LalbaAnthony/docship"
  },
  {
    slug: "menu-planner",
    title: "Menu Planner",
    ...
    year: 2023,
    featured: false,
    productionUrl: "https://menu-planner.fr"
  },
  {
    slug: "ticketops",
    title: "TicketOps",
    ...
    year: 2022,
    featured: false,
    repositoryUrl: "https://github.com/LalbaAnthony/ticketops"
  },
  {
    slug: "codewatch",
    title: "CodeWatch",
    ...
    year: 2022,
    featured: false,
    repositoryUrl: "https://github.com/LalbaAnthony/codewatch"
  },
  {
    slug: "linkvault",
    title: "LinkVault",
    ...
    year: 2021,
    featured: false,
    repositoryUrl: "https://github.com/LalbaAnthony/linkvault"
  },
  {
    slug: "promptforge",
    title: "PromptForge",
    ...
    year: 2025,
    featured: true,
    repositoryUrl: "https://github.com/LalbaAnthony/promptforge"
  },
  {
    slug: "deploykit",
    title: "DeployKit",
    ...
    year: 2025,
    featured: false,
    repositoryUrl: "https://github.com/LalbaAnthony/deploykit"
  },
  {
    slug: "formcraft",
    title: "FormCraft",
    ...
    year: 2024,
    featured: false,
    productionUrl: "https://formcraft.dev",
    repositoryUrl: "https://github.com/LalbaAnthony/formcraft"
  },
  {
    slug: "auditlog",
    title: "AuditLog",
    ...
    year: 2023,
    featured: false,
    repositoryUrl: "https://github.com/LalbaAnthony/auditlog"
  },
  {
    slug: "notifhub",
    title: "NotifHub",
    ...
    year: 2022,
    featured: false,
    repositoryUrl: "https://github.com/LalbaAnthony/notifhub"
  },
  {
    slug: "pricepilot",
    title: "PricePilot",
    ...
    year: 2021,
    featured: false,
    repositoryUrl: "https://github.com/LalbaAnthony/pricepilot"
  }
]
